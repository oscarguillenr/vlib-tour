...
import vlibtour.lobbyroom.LobbyRoomRPCClient;
import vlibtour.lobbyroom.LobbyRoomRPCServer;
...
public class TestScenario3 {
	...
	public void test() throws IOException, TimeoutException, JsonRpcException, InterruptedException {
		...
		LobbyRoomRPCClient rpcClient8 = new LobbyRoomRPCClient();
		//Assert.assertEquals("URL1 : 1 1",rpcClient8.createGroupAndJoinIt("1", "1"));
		LobbyRoomRPCClient rpcClient9 = new LobbyRoomRPCClient();
		//Assert.assertEquals("URL1 : 2 1",rpcClient9.createGroupAndJoinIt("2", "1"));
		LobbyRoomRPCClient rpcClient10 = new LobbyRoomRPCClient();
		//Assert.assertEquals("URL2 : 1 1",rpcClient10.joinAGroup("1", "1"));
		LobbyRoomRPCClient rpcClient11 = new LobbyRoomRPCClient();
