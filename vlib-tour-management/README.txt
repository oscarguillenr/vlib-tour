...
$ asadmin start-domain domain1; asadmin start-database; asadmin deploy vlib-tour-management-bean/target/entity-bean.jar

$ (cd vlib-tour-management-client/; java -classpath $CLASSPATH:../vlib-tour-management-bean/target/entity-bean.jar:target/vlib-tour-management-client-4.0-SNAPSHOT.jar enterprise/entity_bean_client/StatelessJavaClient)
...
vlib-tour-management-client does not work:
...
