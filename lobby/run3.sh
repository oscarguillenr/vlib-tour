...
PRODUCER=eu.telecomsudparis.rabbitmq.tutorial.RPCClient3
CONSUMER=eu.telecomsudparis.rabbitmq.tutorial.RPCServer3
...
sleep 2
java -cp ${JARS} ${PRODUCER} 0 &
sleep 1
java -cp ${JARS} ${PRODUCER} 1 &
sleep 1
java -cp ${JARS} ${PRODUCER} 2 &
sleep 1
java -cp ${JARS} ${PRODUCER} 3 &
sleep 1
java -cp ${JARS} ${PRODUCER} 4 &
sleep 1
java -cp ${JARS} ${PRODUCER} 5 &
sleep 1
java -cp ${JARS} ${PRODUCER} 6 &
sleep 5
kill -15 $TOREMOVE
echo END OF TEST
